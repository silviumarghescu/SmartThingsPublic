 ...
 *  Door Chime
 *
 *  Copyright 2016 Silviu Marghescu
 *
...
definition(
    ...
    description: "Uses a siren (e.g. Aeotec Doorbell) to play a chime when a contact is open",
...
preferences {
	page(name: "mainPage", title: "Play a chime when something happens", install: true, uninstall: true)
...
def mainPage() {
	dynamicPage(name: "mainPage") {
		...
		section {
			input "siren", "capability.alarm", title: "On this siren/door bell", required: true
		}
	}
}
